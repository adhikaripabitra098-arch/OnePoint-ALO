...
export const parseTaskInput = async (
  ...
  try {
    ...
    // Fix: Updated model name to gemini-3-flash-preview as per the guidelines for multimodal tasks
    ...
    // Fix: Directly accessing .text property (not a method) as per GenerateContentResponse guidelines
    if (response.text) {
